...
import pages.Instafin.Page_ChequeManagement_ChequeClearing;
import pages.Instafin.Page_loginPage;
import utils.LoadPropertiesFile_Instafin;

public class TestSuit_ChequeManagement {
	...
	Page_ChequeManagement_ChequeClearing chequeManagement_PageElements = new Page_ChequeManagement_ChequeClearing(driver);
